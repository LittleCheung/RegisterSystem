        ...
        stripe
            ...
            <el-table-column label="操作" width="200" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button v-if="scope.row.status == 1" type="primary"  icon="el-icon-lock"  size="mini" @click="lock(scope.row.id, 0)">锁定</el-button>
                    <el-button v-if="scope.row.status == 0" type="danger"  icon="el-icon-unlock" size="mini" @click="lock(scope.row.id, 1)">取消锁定</el-button>
                </template>
            </el-table-column>
